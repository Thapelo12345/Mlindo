  ...
  const faqItems = [
    {
      ...
      answer: "We primarily service the Johannesburg metropolitan area and surrounding regions, but we can accommodate events throughout South Africa for larger bookings. Contact us for details on service availability for your specific location.",
    },
    {
            ...
            <div>
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-gray-100 hover:bg-purple-600 hover:text-white text-gray-600 p-3 rounded-full transition-colors">
